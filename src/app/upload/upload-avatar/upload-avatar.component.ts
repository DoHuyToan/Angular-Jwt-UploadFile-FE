...
export class UploadAvatarComponent implements OnInit {
  ...
  // Khi upload file qua thẻ input dưới dạng 1 hoặc nhiều file thì tệp đó thông qua sự kiện (change) $event được kích hoạt.
  // Và tất cả file upload sẽ lưu trữ trong $event.target.files.
  onFileChanged($event){
